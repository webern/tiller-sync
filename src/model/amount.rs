...
impl JsonSchema for Amount {
    ...
    fn json_schema(_: &mut SchemaGenerator) -> Schema {
        json_schema!({
            "type": "string",
            "description": "A decimal number, with or without a dollar sign and with or without \
            a dollar sign, negative sign and commas. Examples: 1.0 or -1 or -$1.21 or $3,452.12",
        })
    }
}
