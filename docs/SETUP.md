...
![setup-01-create-project](images/setup-01-create-project.jpg)
...
1. Navigate to **"APIs & Services"** > **"OAuth consent screen"**  
   <img src="images/setup-03a-consent-type.jpg" alt="drawing" width="500"/>
2. Click "Get Started"  
   <img src="images/setup-03b-consent-type.jpg" alt="drawing" width="500"/>
5. Fill in the required fields on the "OAuth consent screen" page:
    - **App name**: `Tiller Sync` (or your preferred name)  
      <img src="images/setup-03c-consent-type.jpg" alt="drawing" width="500"/>
    ...
    - Select **"External"** as the user type (unless you have a Google Workspace account and want to
      ...
      <img src="images/setup-03d-consent-type.jpg" alt="drawing" width="500"/>
...
1. Navigate to the **Audience** tab and scroll down to **Test users**:  
   <img src="images/setup-05a-audience-tab.jpg" alt="drawing" width="500"/>

2. Add your same email here as the **Test user** and Save:  
   <img src="images/setup-05b-test-user.jpg" alt="drawing" width="500"/>

### Step 6: Create OAuth Credentials

1. Navigate to **"APIs & Services"** > **"Credentials"**  
   <img src="images/setup-06a-credentials.jpg" alt="drawing" width="500" border="1"/>
2. Click **"+ Create Credentials"** at the top
3. Select **"OAuth client ID"** from the dropdown  
   <img src="images/setup-06b-oauth-client-id.jpg" alt="drawing" width="500" border="1"/>
4. For **Application type**, select **"Desktop app"**
5. Enter a name: `Tiller Sync` (or your preferred name)  
   <img src="images/setup-06c-desktop-app-name.jpg" alt="drawing" width="500" border="1"/>
6. Click **"Create"**
7. A dialog will appear showing your **Client ID** and **Client Secret**
    - Click **"Download JSON"** to download the credentials file  
      <img src="images/setup-06d-creds-dialog.jpg" alt="drawing" width="500" border="1"/>
8. Click **"OK"** to close the dialog

### Step 7: Note Your Downloaded File Location

In the previous step you downloaded a JSON file. Take note of where it was saved (typically your
Downloads folder). The filename will look like:
...
You now have your OAuth credentials set up. Return to the [README](../README.md#initial-setup) to
continue with the `tiller init` and `tiller auth` commands.
